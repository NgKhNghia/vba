...
Sub SetNameInFirstCell(ws As Worksheet, name As String, rng As Range)
' dat ten file len tren dau cua bang tuong ung
' name la ten file
' start va end la vung chua ten file
...
Sub DeleteRow(ws As Worksheet, startRow As Integer, endRow As Integer)
' xoa cac hang giua ten file va bang tuong ung
' start va end la vung xoa

    ws.Range(ws.Cells(startRow, 1), ws.Cells(endRow, 1)).EntireRow.Delete
End Sub
Sub Newcopysystem(ws1 As Worksheet, ws2 As Worksheet, wsdict As Worksheet)
